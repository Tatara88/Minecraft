...
/* 297 */       return false;
/*     */     }
/* 299 */     return this.dyeItemStacks[5].a().bf == BlockColor.blockId;
/*     */   }
/*     */ 
...
/*     */     }
/* 395 */     if (!mod_ColoredBlock.isMultiplayer()) {
...
/* 508 */       this.d.f(x, y, z, BlockColor.blockId);
/* 509 */       this.d.a(x, y, z, entity);
/* 510 */       if (this.d.a(x, y, z) != BlockColor.blockId) {
/* 511 */         return true;
/*     */       }
/*     */     }
/*     */ 
...
/* 769 */       return;
/*     */     }
/* 771 */     this.image = mod_ColoredBlock.getLocalImage(name);
