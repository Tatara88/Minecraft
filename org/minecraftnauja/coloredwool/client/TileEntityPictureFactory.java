...
/* 297 */       return false;
/*     */     }
/* 299 */     return this.dyeItemStacks[5].a().bf == BlockColoredWool.blockId;
/*     */   }
/*     */ 
...
/* 508 */       this.d.f(x, y, z, BlockColoredWool.blockId);
/* 509 */       this.d.a(x, y, z, entity);
/* 510 */       if (this.d.a(x, y, z) != BlockColoredWool.blockId) {
/* 511 */         return true;
/*     */       }
/*     */     }
/*     */ 
