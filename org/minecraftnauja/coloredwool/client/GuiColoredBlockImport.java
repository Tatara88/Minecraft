...
/* 216 */     BufferedImage image = ColoredWool.getLocalImage(this.fileinputstring);
/* 217 */     if (image == null) {
...
/* 222 */     ColoredWool.imageImport = new ImageImport(this.player, this.entity, image, this.xOrient, this.yOrient);
