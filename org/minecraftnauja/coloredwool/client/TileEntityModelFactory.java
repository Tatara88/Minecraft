...
/*     */     }
/* 423 */     if (!ColoredWool.isMultiplayer()) {
...
/*     */     }
/*     */ 
/* 968 */     this.imageTop = ColoredWool.getLocalImage(name + "/top.png");
/* 969 */     if (this.imageTop == null) return;
/* 970 */     this.imageBottom = ColoredWool.getLocalImage(name + "/bottom.png");
/* 971 */     if (this.imageBottom == null) return;
/* 972 */     this.imageLeft = ColoredWool.getLocalImage(name + "/left.png");
/* 973 */     if (this.imageLeft == null) return;
/* 974 */     this.imageRight = ColoredWool.getLocalImage(name + "/right.png");
/* 975 */     if (this.imageRight == null) return;
/* 976 */     this.imageFront = ColoredWool.getLocalImage(name + "/front.png");
/* 977 */     if (this.imageFront == null) return;
/* 978 */     this.imageBack = ColoredWool.getLocalImage(name + "/back.png");
