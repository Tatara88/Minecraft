...
public class DebugP2PListener implements P2PListener {
	...
	public void onServerStarting(ServerEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onServerStarting %s", event);
	}
	...
	public void onServerStarted(ServerEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onServerStarted %s", event);
	}
	...
	public void onServerShutdown(ServerEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onServerShutdown %s", event);
	}
	...
	public void onClientStarting(ClientEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onClientStarting %s", event);
	}
	...
	public void onClientStarted(ClientEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onClientStarted %s", event);
	}
	...
	public void onClientShutdown(ClientEvent event) {
		FMLLog.log(P2P.MOD_ID, Level.INFO, "onClientShutdown %s", event);
	}
